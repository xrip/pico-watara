...
void tuh_xinput_report_received_cb(uint8_t dev_addr, uint8_t instance, uint8_t const* report, uint16_t len) {
    ...
    gamepad1.bits.a = p->wButtons & XINPUT_GAMEPAD_A;
    gamepad1.bits.b = p->wButtons & XINPUT_GAMEPAD_B;
    gamepad1.bits.select = p->wButtons & XINPUT_GAMEPAD_BACK;
    gamepad1.bits.start = p->wButtons & XINPUT_GAMEPAD_START;
    ...
    gamepad1.bits.down = down;
    gamepad1.bits.up = up;
    gamepad1.bits.left = left;
    gamepad1.bits.right = right;
    /*char tmp[128];
